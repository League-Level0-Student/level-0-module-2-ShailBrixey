...
public class StringsCannotAdd {
		...
		public static void main(String[] args) {
			...
			int addingFour = Integer.parseInt(fourAsString);
			// 7) Do the same for sixAsString. 
			int addingSix = Integer.parseInt(sixAsString);
			// 8) Print the addition of fourAsInt and sixAsInt using JOptionPane 
			JOptionPane.showMessageDialog(null, addingFour+addingSix);
			...
			int addingFive = Integer.parseInt(fiveAsString);
			// 10) Print the addition of fourAsInt, sixAsInt, and fiveAsInt using JOptionPane 
			JOptionPane.showMessageDialog(null, addingFour+addingSix+addingFive);
